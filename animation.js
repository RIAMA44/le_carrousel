...
function printImg(){ //fonction d'affichage des images
 ...
 $titre.css('display', 'none'); // on cache les images
    $currentTitre = $titre.eq(i); // on définit la nouvelle image
    $currentTitre.css('display', 'block');
}
...
$('.avant').click(function(){ // image précédentes
